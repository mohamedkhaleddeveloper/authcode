                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="projectinput1" class="form-control" placeholder="{{__('Arabic Name')}}" name="name_ar" >
                                                    <input type="hidden"  name="code" value="54121" >
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="projectinput2">{{__('English Name')}}</label>
                                                    <input type="text" id="projectinput2" class="form-control" placeholder="{{__('English Name')}}" name="name_en" >
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="projectinput3">{{__('E_mail')}}</label>
                                                    <input type="mobile" id="projectinput3" class="form-control" placeholder="{{__('E_mail')}}" name="email">
                                                </div>
                                            </div>
